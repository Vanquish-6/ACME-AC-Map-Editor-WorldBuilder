...
namespace WorldBuilder.Lib.Settings {
    ...
    public partial class AppSettings : ObservableObject {
        [SettingDescription("Directory where all ACME WorldBuilder projects are stored")]
        ...
        [SettingDescription("Show the Getting Started guide the first time a project opens")]
        [SettingOrder(6)]
        private bool _showGettingStarted = true;
        public bool ShowGettingStarted { get => _showGettingStarted; set => SetProperty(ref _showGettingStarted, value); }
    }
}