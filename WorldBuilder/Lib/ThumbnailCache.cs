...
namespace WorldBuilder.Lib {
    ...
    public class ThumbnailCache {
        ...
        public ThumbnailCache(string? cacheNamespace = null) {
            string scope = string.IsNullOrWhiteSpace(cacheNamespace) ? "global" : cacheNamespace;
            _cacheDir = Path.Combine(
                Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
                "ACME WorldBuilder", "thumbnails", CacheVersion, scope);
