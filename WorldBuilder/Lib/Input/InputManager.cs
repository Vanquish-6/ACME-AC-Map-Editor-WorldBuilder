...
namespace WorldBuilder.Lib.Input {
    public class InputManager {
        ...
        private List<InputBinding> GetDefaultBindings() {
            ...
            list.Add(new InputBinding(InputActions.EditDuplicate, Key.D, KeyModifiers.Control, "Duplicate", "Edit"));
            list.Add(new InputBinding(InputActions.EditFocusSelection, Key.F, KeyModifiers.None, "Focus Selection", "Edit"));
            list.Add(new InputBinding(InputActions.BrushSmaller, Key.OemOpenBrackets, KeyModifiers.None, "Smaller Brush", "Brush"));
            list.Add(new InputBinding(InputActions.BrushLarger, Key.OemCloseBrackets, KeyModifiers.None, "Larger Brush", "Brush"));
