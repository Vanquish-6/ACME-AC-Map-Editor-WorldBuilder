namespace WorldBuilder.Lib.Input {
    public static class InputActions {
        ...
        public const string EditDuplicate = "Edit.Duplicate";
        public const string EditFocusSelection = "Edit.FocusSelection";
        public const string BrushSmaller = "Brush.Smaller";
        public const string BrushLarger = "Brush.Larger";
