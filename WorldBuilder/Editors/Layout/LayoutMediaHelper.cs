...
namespace WorldBuilder.Editors.Layout {
    ...
    public static class LayoutMediaHelper {
        ...
        public static void PopulateStateRows(ElementDesc el, ObservableCollection<LayoutStateRow> rows, IDatReaderWriter? stringDats = null,
        ...
        static LayoutStateRow MakeRow(string label, StateDesc sd, ElementDesc owner, IDatReaderWriter? stringDats,
