...
namespace WorldBuilder.Editors.Landscape.ViewModels {
    public partial class HeightRaiseLowerSubToolViewModel : SubToolViewModelBase, IBrushSettings {
        ...
        private void ApplyPreviewChanges(Vector3 centerPosition) {
            ...
            int deltaBase = _isLowering ? -Strength : Strength;
            ...
            foreach (var (lbId, vIndex, vertPos) in affected) {
                ...
                int delta = (int)Math.Round(deltaBase * weight);
