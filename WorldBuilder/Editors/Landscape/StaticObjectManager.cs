...
namespace WorldBuilder.Editors.Landscape {
    public class StaticObjectManager : IDisposable {
        ...
        /// </summary>
        public ColorARGB[]? CreaturePalette { get; set; }
        ...
        public StaticObjectManager(OpenGLRenderer renderer, IDatReaderWriter dats, TextureDiskCache? textureCache = null) {
            ...
            _objectShader = _renderer.GraphicsDevice.CreateShader("StaticObject",
                GameScene.GetEmbeddedResource("Acme.Render.GL.Shaders.StaticObject.vert", assembly),
                GameScene.GetEmbeddedResource("Acme.Render.GL.Shaders.StaticObject.frag", assembly));
        }
            ...
            switch (renderSurface.FormatEnum) {
                ...
                case DatPixelFormat.PFID_INDEX16: {
                    ...
                    if (CreaturePalette != null) {
                        TextureHelpers.FillIndex16(renderSurface.SourceData, CreaturePalette, textureData.AsSpan(), w, h, isClipMap);
                    }
                    else {
