...
namespace WorldBuilder.Shared.Lib.AceDb {
    /// <summary>
    /// Thin wrapper around MySqlConnector for reading/writing
    /// landblock_instance rows in the world database.
    /// </summary>
    public partial class AceDbConnector : IDisposable {
        ...
        /// <summary>
        /// Generates a single INSERT statement for landblock_instance.
        ...
        /// </summary>
        public static string GenerateInsertSql(LandblockInstanceRecord record, string databaseName = "") {
            ...
            string table = string.IsNullOrWhiteSpace(databaseName)
                ? "`landblock_instance`"
                : $"`{databaseName}`.`landblock_instance`";
            return string.Format(System.Globalization.CultureInfo.InvariantCulture,
                "INSERT INTO {0} (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_w`, `angles_x`, `angles_y`, `angles_z`) VALUES ({1}, {2}, {3}, {4:F6}, {5:F6}, {6:F6}, {7:F6}, {8:F6}, {9:F6}, {10:F6});",
                table, guid, record.WeenieClassId, record.ObjCellId,
        ...
        /// </summary>
        public static string GenerateInsertSqlBatch(IEnumerable<LandblockInstanceRecord> records, string databaseName = "") {
        ...
        /// <summary>
        /// Loads weenie class IDs, names, and setup DIDs from the world database for picker/list UI.
